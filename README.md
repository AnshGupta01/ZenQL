...
|--------------:|--------------------------:|-------------:|---------------:|
| **100** | 0 | < 0.01s | **176600** |
| **1 Thousand** | 0 | < 0.01s | **297284** |
| **10 Thousand** | 0 | < 0.01s | **369295** |
| **100 Thousand** | 0 | < 0.01s | **398015** |
| **1 Million** | 0 | < 0.01s | **610725** |
| **10 Million** | 0 | < 0.01s | **718327** |
| **1 Trillion** | 0 | 1.60s | **0.6 JOIN/s** |

---

## 🏆 Final Performance Milestones

These results represent the peak vertical scalability of the ZenQL engine on modern hardware:

*   **1 Trillion Comparisons (1M x 1M JOIN)**: **1.60 seconds** 🚀
*   **Point-Lookup Latency**: **1.47 us/query** 🎯 (Multi-Core Parallel @ **682,091 query/s**)
*   **Data Ingestion**: **~731,657 rows/sec** (Stable on 10M row scale)

For more architectural details, see [DESIGN.md](DESIGN.md).
